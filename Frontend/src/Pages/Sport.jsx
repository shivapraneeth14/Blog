...
function Sport() {
  ...
  useEffect(() => {
    const getPosts = async () => {
      try {
        ...
        // Filter blogs that contain the "Sport" tag
        const filteredBlogs = response.data.blogs.filter(blog => blog.tags.includes("Sport"));
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">Sport Blogs</h1>
